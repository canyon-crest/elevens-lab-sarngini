 ...
 */
public abstract class Board11 {

	/**
	 * The cards on this board.
	 */
	private Card11[] cards;
	 ...
	 *                    the deck
	 */
	public Board11(int size, String[] ranks, String[] suits, int[] pointValues) {
		cards = new Card11[size];
		deck = new Deck11(ranks, suits, pointValues);
		if (I_AM_DEBUGGING) {
